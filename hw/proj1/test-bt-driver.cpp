...
{
    Survivor there("Richard", "Hatch1", "woodside", "ny", 15),
        notthere("Tom", "Hanks", "woodside", "ny", 15);
    bool found;
...
{
    Survivor leaf("Richard", "Hatch3", "woodside", "ny", 15),
        root("Richard", "Hatch1", "woodside", "ny", 15),
        deepest("Richard", "Hatch5", "woodside", "ny", 15),
        alreadyremoved("Richard", "Hatch5", "woodside", "ny", 15);
